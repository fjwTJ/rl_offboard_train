...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--reset-timeout-sec', type=float, default=60.0)
    parser.add_argument('--reset-retry-sleep-sec', type=float, default=1.0)
    parser.add_argument('--max-step-timeout-retries', type=int, default=3)
    parser.add_argument('--max-reset-timeout-retries', type=int, default=3)
    ...
    parser.add_argument('--reset-timeout-event-topic', default='/rl/reset_timeout')
...
def main() -> None:
    ...
    env = RosTargetTrackingEnv(
        ...
        reset_timeout_event_topic=args.reset_timeout_event_topic,
